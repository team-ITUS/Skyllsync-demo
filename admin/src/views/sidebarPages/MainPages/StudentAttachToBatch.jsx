...
const StudentAttachToBatch = () => {
  const { token, batchName } = useParams();
  ...
  return (
    <Container className="mainTableContainer">
      <div className="row p-2 my-4">
        <div className="col-2">
          <img src="IRA_Logo.svg" alt="" style={{height:"100px"}} />
        </div>
        <div className="col-8"> 
          <h4 className="text text-center" style={{ color: "black", marginBottom: "3%", fontSize: "28px" }}>
        Trainee Registration for {batchName}
          </h4>
        </div>
      </div>
      <Form className="px-5">
...
export default StudentAttachToBatch;